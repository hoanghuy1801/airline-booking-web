            ...
            <Row className='main-checkin'>
                <Col xs={24} sm={24} md={9} lg={9} xl={9} className='form-search-checkin'>
                    ...
                    <p className='notification'>
                        Sẵn sàng cho chuyến bay vui vẻ, thoải mái, bạn có thể làm thủ tục chuyến bay trực tuyến nhanh
                        chóng và đơn giản.
                    </p>
                    <Form>
                        <Form.Item>
                            <label className='lable-form'>
                                Mã đặt chỗ <span style={{ color: 'red' }}>*</span>
                            </label>
                            <Input
                ...
                <Col xs={24} sm={24} md={15} lg={15} xl={15} className='notification-checkin'>
                    <p className='notification-header'>
                        ...
                        Check-in) tại trang web của Vivu hoặc ứng dụng Vivu trên thiết bị di động. Đây là tính năng tiện
                        lợi, nhanh gọn để Quý khách có thể dễ dàng thực hiện mọi lúc mọi nơi từ 24 tiếng đến 60 phút
                        trước giờ bay.
                    </p>
                    <p className='notification-title'>I. Các chuyến bay khai thác bởi Vivu</p>
                    ...
                    <ul className='notification-ul'>
                        ...
                        <li>
                            Nhật Bản: Sân bay Narita (NRT), Haneda (HND), Fukuoka (FUK), Kansai (KIX), Nagoya Chubu
                            (NGO)
                        </li>
                        ...
                        <li>
                            ...
                            Nhất: từ 24 tiếng đến 3 tiếng trước giờ khởi hành)
                        </li>
                        <p className='notification'>Quy định chung: </p>
                        <li>
                            Quý khách cần chuẩn bị đầy đủ giấy tờ du lịch, còn hạn, phù hợp quy định Xuất/Nhập cảnh và
                            lưu trú.
                        </li>
                        <li>
                            Quý khách làm thủ tục trực tuyến (Online Check-in) và in ra Thẻ lên tàu bay dưới dạng khổ
                            giấy A4 trước khi ra sân bay. Thẻ lên tàu bay định dạng điện tử lưu trên thiết bị di động
                            (điện thoại, máy tính bảng, email,...) đều không có giá trị sử dụng trên các chuyến bay Quốc
                            tế.
                        </li>
                        <li>
                            Tại sân bay: Quý khách có mặt tại quầy phục vụ khách Online Check-in trước giờ khởi hành 60
                            phút để nhân viên xác thực thông tin: Giấy tờ du lịch, Giấy tờ xuất/nhập cảnh và các giấy tờ
                            khác theo quy định từ Nhà chức trách, Cơ quan xuất/nhập cảnh trước khi Quý khách vào khu vực
                            xuất cảnh bên trong. Quy định này áp dụng bao gồm cả Quý khách không có hành lý ký gửi.
                        </li>
                        <li>
