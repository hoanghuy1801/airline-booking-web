...
const Service = (props) => {
    ...
    const onChangePassengersRoundTrip = async (value) => {
        if (value === 'true') {
            let res = await getServiceAirline(flightSelectReturn.id, flightSelectReturn.airline.id, data.seatId)
                            ...
                            return (
                                <Card key={item.id} className='food-service-card'>
                                    <Row>
                                        ...
                                        <Col span={14}>
                                            <Row>
                                                <span style={{ fontSize: '18px', fontWeight: 500, paddingTop: '10px' }}>
                                                    {item.optionName}
                                                </span>
                                            </Row>
                                            <Row>
