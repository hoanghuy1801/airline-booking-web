        ...
        <div className='main-homepage'>
            <div className='homePage'>
                ...
                <div className='search'>
                    <FormSearch listAirports={listAirports} listSeats={listSeats} />
                </div>
            ...
            <div className='col-inner'>
                <div className='inner'>
                    <Divider style={{ borderColor: 'black', fontSize: 20, paddingBottom: 20, paddingRight: 70 }}>
                        {getText('service')}
                    </Divider>
                    <Row>
                        <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                            ...
                            >
                                <Col span={4}>
                                    <Image src={imgTicket} preview={false} />
                                </Col>
                                <Col span={20}>
                                    <Row>
                        ...
                        <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                            ...
                            >
                                <Col span={4}>
                                    <Image src={imgLock} preview={false} />
                                </Col>
                                <Col span={20}>
                                    <Row>
                        ...
                        <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                            ...
                            >
                                <Col span={4}>
                                    <Image src={imgSeat} preview={false} />
                                </Col>
                                <Col span={20}>
                                    <Row>
                    ...
                    <Row>
                        <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                            ...
                            >
                                <Col span={4}>
                                    <Image src={imgLuggage} preview={false} />
                                </Col>
                                <Col span={20}>
                                    <Row>
                        ...
                        <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                            ...
                            >
                                <Col span={4}>
                                    <Image src={imgVat} preview={false} />
                                </Col>
                                <Col span={20}>
                                    <Row>
                        ...
                        <Col xs={24} sm={8} md={8} lg={8} xl={8}>
                            ...
                            >
                                <Col span={4}>
                                    <Image src={imgBaby} preview={false} />
                                </Col>
                                <Col span={20}>
                                    <Row>
